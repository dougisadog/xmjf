...
public class DESUtils {
	...
	public final static String default_key = "14725836";
	...
	public static String decrypt(InputStream body, String defaultKey) {
		String message = convertStreamToString(body);
